...
class UserProfileResponse(BaseModel):
    ...
    additional_attributes: Optional[Dict[str, StrictStr]] = Field(default=None, alias="additionalAttributes")
    created_at: Optional[datetime] = Field(default=None, alias="createdAt")
    updated_at: Optional[datetime] = Field(default=None, alias="updatedAt")
    __properties: ClassVar[List[str]] = ["login", "email", "firstName", "lastName", "birthDate", "mail", "phoneNumber", "additionalAttributes", "createdAt", "updatedAt"]
